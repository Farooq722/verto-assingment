  ...
  return (
    <div className="bg-gray-200 border border-gray-700 h-screen mt-5 rounded-2xl">
      <div className=" flex justify-between items-center mx-8 mt-2 font-sans">
        ...
        <p className="text-2xl font-bold text-gray-700">Count: {allEmployees.length}</p>
      </div>
            ...
            <div className="flex flex-wrap justify-between items-center gap-4 mx-4 border py-3 px-4 rounded-xl bg-gray-300">
              ...
              <div className="flex gap-2 shrink-0">
                {isOpen && (
                  ...
                  >
                    <div
                      className="rounded-lg p-6 w-96 relative bg-white"
                      ...
                      <form onSubmit={handleSubmit(submittHandler)}>
                        <div className="flex items-center mt-6">
                          ...
                          <input
                            ...
                            className="px-4 py-1.5 rounded w-[70%] border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 transition-colors"
                            {...register("name")}
                          />
                        </div>
                        {errors.name && (
